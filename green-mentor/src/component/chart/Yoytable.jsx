...
function Yoytable() {
  ...
  return (
    <div className="TableS">
      <Box className="TableB">
        <Flex justifyContent="space-between">
          <Flex className='TableSupp'>
            <Text className="TabletextSupp">Supplier-wise</Text>
            <svg
          ...
          <Flex className="TabletextDow-1">
            ...
            <Text className="TabletextDow-2">Download</Text>
          </Flex>
        </Flex>
      </Box>
      <div>
      ...
      <Tbody>
        {Data_23.map((el, ind) => (
          ...
          <Tr key={ind}>
            ...
            <Td>
            {+el.YOYRE < 0 ? (
      <span>{el.YOYRE}&uarr;</span> // Up arrow for negative value
    ) : (
      <span>{el.YOYRE}&darr;</span> // Down arrow for positive value
    )}
            </Td>
          </Tr>
        ))}
